...
write-files:
  ...
  - path: /etc/hosts
    ...
    content: |
      ${custom_host_entry}
      ${master1IP} k8smaster1
      ${master2IP} k8smaster2
      ${master3IP} k8smaster3
  - path: /opt/kubeconfig
    permissions: 0755
    content: |
      apiVersion: v1
...
coreos:
  flannel:
      etcd_endpoints: "http://k8smaster1:2379,http://k8smaster2:2379,http://k8smaster3:2379"
  units:
    ...
    - name: kube-proxy.service
      ...
      content: |
        ...
        ExecStartPre=/opt/bin/wupiao k8smaster1 8080
        ExecStart=/opt/bin/kube-proxy \
        --master=https://k8smaster1:6443 \
    ...
    - name: kube-kubelet.service
      ...
      content: |
        ...
        --address=0.0.0.0 \
        --port=10250 \
        --api-servers=https://k8smaster1:6443,https://k8smaster2:6443,https://k8smaster3:6443 \
